        ...
        <div class="collapse navbar-collapse" id="edicaMainNav">
            <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" id="blogDropdown" data-toggle="dropdown"
...
@section('content')
    <main class="blog">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    <form action="{{ route('main.news.index') }}">
                        <div class="input-group">
                            <input type="search" class="form-control form-control-lg" name="content" placeholder="Найти новость">
        ...
        <div class="container">
            <h1 class="edica-page-title" data-aos="fade-up">Все новости</h1>
